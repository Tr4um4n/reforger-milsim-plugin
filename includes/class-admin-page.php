	...
	private function get_shortcodes_reference() {
		return array(
			...
			array(
				...
				'description' => 'Nombre del autor/creador de la misión.',
				'context'     => 'Misiones, Eventos (hereda de misión)',
				'params'      => 'Sin parámetros',
			),
			array(
				'shortcode'   => '[rmm_orbat]',
				'description' => 'Muestra el ORBAT. Estilo MILSIM en misiones, CARDS en eventos.',
				'context'     => 'Misiones, Eventos',
				'params'      => 'style="milsim|cards"',
			),
			array(
				'shortcode'   => '[rmm_addons_list]',
				'description' => 'Lista colapsable de addons/dependencias requeridos.',
				'context'     => 'Misiones, Eventos (hereda de misión)',
				'params'      => 'Sin parámetros',
			),
			array(
				'shortcode'   => '[clan_orbat]',
				'description' => 'Shortcode legacy. Equivale a [rmm_orbat] + [rmm_addons_list].',
				'context'     => 'Misiones, Eventos',
				'params'      => 'Sin parámetros',
			),
			array(
				'shortcode'   => '[rmm_mission_map]',
				'description' => 'Mapa de misión con datos en tiempo real del addon. Muestra posiciones de jugadores, marcadores de misión y brújula. Incluye botón DAGR para generar QR de acceso móvil.',
				'context'     => 'Misiones (página de misión)',
				'params'      => 'id="post_id" height="600px" session_id="SESSION_01"',
			),
			array(
				'shortcode'   => '[rmm_microdagr]',
				'description' => 'Botón independiente MicroDAGR. Genera QR para usar el GPS táctico en el móvil. Requiere usuario logueado con steamid.',
				'context'     => 'Global, Misiones',
				'params'      => 'session_id="SESSION_01" post_id="123"',
			),
			array(
				'shortcode'   => '[rmm_tactical_map]',
				'description' => 'Mapa táctico DAGR estático. Usa datos predefinidos vía JSON (markers y positions) o un preset guardado.',
				'context'     => 'Global',
				'params'      => 'map="everon|arland|cain" height="600px" id="preset_id" markers=base64 positions=base64',
			),
			array(
				'shortcode'   => '[rmm_last_match]',
				'description' => 'Tarjeta táctica con datos de la última partida: fecha, horario, escenario, jugadores y estadísticas totales (bajas, muertes, disparos, aciertos).',
				'context'     => 'Global',
				'params'      => 'Sin parámetros',
			),
			array(
				'shortcode'   => '[rmm_missions_grid]',
				'description' => 'Rejilla de misiones con estilo táctico, imágenes, autor y badges de addons.',
				'context'     => 'Global',
				'params'      => 'count="6" category="slug"',
			),
			array(
				'shortcode'   => '[coordenadas_militar]',
				'description' => 'Coordenadas militares geolocalizadas del visitante con estilo táctico tipo terminal.',
				'context'     => 'Global',
				'params'      => 'Sin parámetros',
			),
			array(
				'shortcode'   => '[rmm_server_manager]',
				'description' => 'Gestor de servidor en frontend. Solo visible para roles autorizados.',
				'context'     => 'Global (restringida)',
				'params'      => 'Sin parámetros',
			),
			array(
				'shortcode'   => '[rmm_server_status]',
				'description' => 'Monitor de estado: ONLINE/OFFLINE, versión, jugadores y mapa actual.',
				'context'     => 'Global',
				'params'      => 'Sin parámetros',
			),
			array(
				'shortcode'   => '[rmm_server_resources]',
				'description' => 'Monitor de recursos: CPU, RAM y disco con barras de progreso.',
				'context'     => 'Global',
				'params'      => 'Sin parámetros',
			),
			array(
				'shortcode'   => '[rmm_server_info]',
				'description' => 'Información de conexión: IP, puerto y enlace directo.',
				'context'     => 'Global',
				'params'      => 'Sin parámetros',
			),
			array(
				'shortcode'   => '[clan_lista_miembros]',
				'description' => 'Cuadrícula táctica de miembros con avatar, nombre, pasador y overlay de stats. Click → expediente.',
				'context'     => 'Global',
				'params'      => 'role="activo|reservista|aliado" count="12"',
			),
			array(
				'shortcode'   => '[clan_perfil_operador]',
				'description' => 'Ficha militar completa del operador: condecoraciones, dossier de combate y cronología.',
				'context'     => 'Global',
				'params'      => 'user_id="123" steamid="7656..."',
			),
			array(
				'shortcode'   => '[clan_pasador_medallas]',
				'description' => 'Pasador de diario (Ribbon Rack) con medallas ordenadas por prioridad visual.',
				'context'     => 'Global',
				'params'      => 'user_id="123"',
			),
			array(
				'shortcode'   => '[clan_solicitar_raid]',
				'description' => 'Formulario para solicitar RAID. Solo visible para Activo/Aliado. Notifica a Telegram.',
				'context'     => 'Global',
				'params'      => 'Sin parámetros',
			),
			array(
				'shortcode'   => '[clan_calendario]',
				'description' => 'Calendario táctico interactivo. Móvil: vista lista. Escritorio: vista mensual.',
				'context'     => 'Global',
				'params'      => 'Sin parámetros',
			),
			array(
				'shortcode'   => '[hora_zulu]',
				'description' => 'Hora actual en formato ZULU (UTC). Ej: 20:30:00 ZULU.',
				'context'     => 'Global',
				'params'      => 'Sin parámetros',
			),
			array(
				'shortcode'   => '[raid_aprobar]',
				'description' => 'Botones para aprobar/rechazar solicitud de RAID. Solo admin.',
				'context'     => 'RAIDs',
				'params'      => 'Sin parámetros',
			),
			array(
				'shortcode'   => '[raid_lista_participantes]',
				'description' => 'Lista de participantes apuntados a la RAID con nombre y hora.',
				'context'     => 'RAIDs',
				'params'      => 'Sin parámetros',
			),
			array(
			...
			array(
				'shortcode'   => '[raid_faq]',
				'description' => 'Preguntas frecuentes sobre el sistema de RAIDs.',
				'context'     => 'RAIDs',
				'params'      => 'Sin parámetros',
			),
		);
